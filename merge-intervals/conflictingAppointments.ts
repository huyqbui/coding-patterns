...
const conflictingAppointments = (n: number[][]) => {
  n.sort((a, b) => a[0] - b[0])
...
console.log(conflictingAppointments([[1,4], [2,5], [7,9]])) //-> false ([1,4] and [2,5] conflict)
console.log(conflictingAppointments([[6,7], [2,4], [8,12]])) //-> true
console.log(conflictingAppointments([[4,5], [2,3], [3,6]])) //-> false ([3,6] and [4,5] conflict)